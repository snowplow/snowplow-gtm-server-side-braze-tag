...
The Snowplow Braze Tag for Google Tag Manager Server-side is maintained by the Engineering team at Snowplow Analytics. We welcome suggestions for improvements and bug fixes to all Snowplow GTM Server Side Repositories.
...
[the issues labeled `good first issue`](https://github.com/snowplow/snowplow-gtm-server-side-braze-tag/labels/good%20first%20issue).
