...
The Snowplow Braze Tag for Google Tag Manager Server-side is maintained by the Engineering team at Snowplow. We welcome suggestions for improvements and bug fixes to all Snowplow GTM Server Side Repositories.
