# Snowplow Braze Tag for Google Tag Manager Server-side
...
## Snowplow Braze Tag for Google Tag Manager Server-side Overview

A Google Tag Manager Server-side Tag template for sending events from the Snowplow Client (and other GTM SS Clients) to Braze.

This Tag allows you to forward events in your Google Tag Manager Server container to a Braze REST API Endpoint.
...
Snowplow Braze Tag for Google Tag Manager Server-side is copyright 2022 Snowplow Analytics Ltd.
...
[releases]: https://github.com/snowplow/snowplow-gtm-server-side-braze-tag/releases
[release-image]: https://img.shields.io/github/v/release/snowplow/snowplow-gtm-server-side-braze-tag
...
[techdocs]: https://docs.snowplowanalytics.com/docs/forwarding-events-to-destinations/forwarding-events/google-tag-manager-server-side/braze-tag-for-gtm-ss/braze-tag-configuration/
[techdocs-image]: https://d3i6fms1cm1j0i.cloudfront.net/github/images/techdocs.png
[setup]: https://docs.snowplowanalytics.com/docs/forwarding-events-to-destinations/forwarding-events/google-tag-manager-server-side/braze-tag-for-gtm-ss/
